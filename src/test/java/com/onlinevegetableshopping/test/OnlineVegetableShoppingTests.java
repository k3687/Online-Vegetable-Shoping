...
//		@Test
//		public void testGetVegetableById() {
//			int id = 1;
//			adminServe.getById(1);
//			verify(vegRepo, times(1)).getById(1);
//		}
//		
//		@Test
//		public void testGetOrderById() {
//			int orderId = 112;
//			adminServe.getOrderById(112);
//			verify(orderRepo, times(1)).getById(112);
//		}
//		
//		
//		@Test
...
//			int id = 112;
//			adminServe.viewUserById(112);
//			verify(userRepo, times(1)).getById(112);
//		}
