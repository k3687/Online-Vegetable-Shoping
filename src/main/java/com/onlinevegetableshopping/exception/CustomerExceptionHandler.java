...
public class CustomerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleVegetableIdNotFoundException(){
		...
		return new ResponseEntity<Object>("This id not present in data base",HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<Object> handleUserIdNotFoundException(){
		...
		return new ResponseEntity<Object>("Please enter valid user id",HttpStatus.BAD_REQUEST);
	}
